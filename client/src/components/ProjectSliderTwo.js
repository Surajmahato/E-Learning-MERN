    ...
    let data = [
      {
        ...
        serviceExcerpt:
          "Design simple views for each state in your application, and will efficiently update and render just the right components changes",
      ...
      },
      {
        ...
        serviceExcerpt:
          "JavaScript is a dynamic computer programming language, lightweight and most commonly used as a part of web pages.",
        serviceUrl: "service-details-left-sidebar"
      },
      {
        img: "3.png",
        ...
        serviceExcerpt:
          "MongoDB Atlas automates infrastructure provisioning, setup, and deployment so teams can get the database resources they need.",
        serviceUrl: "service-details-left-sidebar"
      }
    ];
